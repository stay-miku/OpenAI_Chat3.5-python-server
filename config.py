...
# 是否使用代理服务器,启用后需要将该配置下面的两个配置改成自己需要的,urllib3需要1.25.11版本,高版本会报错
proxy_enable = False

# 代理服务器地址,代理和服务端在同一设备上填127.0.0.1
proxy_server = "127.0.0.1"

# 代理服务器端口,clash默认端口为7890,别的需要自己去找了(提示:windows开启代理后只要软件配置的是自动配置系统代理,就可以去设置里找到配置的端口)
proxy_port = 7890
